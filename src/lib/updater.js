...
var Updater = /** @class */ (function () {
    function Updater() {
        ...
        this.releaseChannel = atom.config.get('atom-updater-linux.useBeta')
            ? typings_1.ReleaseType.Beta
            : typings_1.ReleaseType.Stable;
        this.versions = null;
        this.configWatcher();
    }
    ...
    Updater.prototype.checkForUpdate = function (notifIfFalse) {
        ...
        return this.getLatestVersionNum()
            ...
            if (_this.requiresUpdate() && _this.versions !== null) {
                Notifier.updateAvailable(_this.versions[_this.releaseChannel], function () {
    ...
    Updater.prototype.detectVersion = function () {
        var _this = this;
        child_process_1.exec('cat /etc/redhat-release', function (err, stdout) {
            if (err === null) {
